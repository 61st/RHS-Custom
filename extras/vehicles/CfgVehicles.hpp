...
class CfgVehicles {
        ...
        class Turrets: Turrets {
            class MainTurret: MainTurret {
                ...
                magazines[] = {
                    ...
                    QUOTE(rhs_mag_230Rnd_25mm_M242_HEI),
                    QUOTE(rhs_mag_230Rnd_25mm_M242_HEI),
                    QUOTE(rhs_mag_230Rnd_25mm_M242_HEI),
                    QUOTE(rhs_mag_230Rnd_25mm_M242_HEI),

                    QUOTE(rhs_mag_70Rnd_25mm_M242_APFSDS),
                    QUOTE(rhs_mag_70Rnd_25mm_M242_APFSDS),
                    QUOTE(rhs_mag_70Rnd_25mm_M242_APFSDS),
                    QUOTE(rhs_mag_70Rnd_25mm_M242_APFSDS),
    ...
    class lxim_thunder_base_F: I_APC_Wheeled_03_cannon_F {
        scope = 1;
        scopeCurator = 1;
        displayName = "M25";
        author = QAUTHOR;
        ...
        class AcreRacks {
            class Rack_1 {
                ...
                mountedRadio = "ACRE_PRC117F";                 // Predefined mounted radio
                isRadioRemovable = 1;                 // Radio can be removed
                intercom[] = {"intercom_1"};                      // No access to intercoms. All units in intercom will be able to hear/send transitions (ACE3 interaction menu) but they cannot manipulate the radio (GUI interface)
            };
            class Rack_2 {
                displayName = "SQUAD";             // Name displayed in the interaction menu
                shortName = "SQD";
    ...
    class lxim_thunder_g: lxim_thunder_base_F {
        displayName = "M20A2";
        scope = 2;
        scopeCurator = 2;
        faction = QUOTE(PREFIX);
    ...
    class lxim_thunder_g_V26: lxim_thunder_base_F {
        scope = 2;
        scopeCurator = 2;
        displayName = "M25 Thunder 2/6";
        author = QAUTHOR;
    ...
    class lxim_thunder_d: lxim_thunder_base_F {
        scope = 2;
        scopeCurator = 2;
        faction = QUOTE(PREFIX);
        forceInGarage = 0;
    ...
    class lxim_thunder_d_V26: lxim_thunder_base_F {
        scope = 2;
        scopeCurator = 2;
        displayName = "M25 Desert Thunder 2/6";
        author = QAUTHOR;
