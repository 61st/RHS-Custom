...
_playerIcon = _unit getVariable "diwako_dui_indicators_customIcon";
    ...
    switch (true) do {
        ...
        case (_playerIcon == "z\lxir\addons\media\images\Icons\eng2.paa") : {_return = 'iconseng2'};
        case (_playerIcon == "z\lxir\addons\media\images\Icons\jtac.paa") : {_return = 'iconsjtac'};
        case (_playerIcon == "z\lxir\addons\media\images\Icons\med2.paa") : {_return = 'iconsmed2'};
        ...
        case (_playerIcon == "z\lxir\addons\media\images\Icons\cmd.paa") : {_return = 'iconscmd'};
        case (_playerIcon == "z\lxir\addons\media\images\Icons\gunner.paa") : {_return = 'iconsgunner'};
        case (_playerIcon == "z\lxir\addons\media\images\Icons\driver.paa") : {_return = 'iconsdriver'};
