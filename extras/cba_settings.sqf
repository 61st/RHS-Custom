...
force lxir_bft_bftEnabled = false;
...
force force lxir_bft_showOwnFactionOnly = true;
...
// 61st - channels
force lxir_channels_CommandDuration = 0;
force lxir_channels_CommandText = true;
force lxir_channels_CommandVoice = false;
force lxir_channels_DirectDuration = 0;
force lxir_channels_DirectText = true;
force lxir_channels_DirectVoice = false;
force lxir_channels_GlobalDuration = 300;
force lxir_channels_GlobalText = true;
force lxir_channels_GlobalVoice = false;
force lxir_channels_GroupDuration = 300;
force lxir_channels_GroupText = true;
force lxir_channels_GroupVoice = false;
force lxir_channels_SideDuration = 300;
force lxir_channels_SideText = true;
force lxir_channels_SideVoice = false;
force lxir_channels_VehicleDuration = 300;
force lxir_channels_VehicleText = true;
force lxir_channels_VehicleVoice = false;
