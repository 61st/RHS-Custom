class ScreenConfigDialog {
    ...
    class controlsBackground {
        class Backdrop: LXIR_CC_RscText
        {
            idc = 1001;
    ...
    class controls {
        class TitleText: LXIR_CC_RscText
        {
            idc = 1000;
            style = "ST_TITLE_BAR";
        ...
        class DroneText: LXIR_CC_RscText
        {
            idc = 1003;
        ...
        class ButtonCancel: LXIR_CC_RscButton
        {
            idc = 1101;
        ...
        class CamSelectText: LXIR_CC_RscText
        {
            idc = 1006;
            text = "Target:";
        ...
        class DroneSelectText: LXIR_CC_RscText
        {
            idc = 1007;
            text = "Drone:";
            x = "10 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X";
        ...
        class SatSelectText: LXIR_CC_RscText
        {
            idc = 1008;
            text = "Center on:";
            x = "10 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X";
        ...
        class CamSelectCombo: LXIR_CC_RscCombo
        {
            idc = 2100;
        ...
        class DroneSelectCombo: LXIR_CC_RscCombo
        {
            idc = 2101;
            x = "15 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X";
            y = "12 * GUI_GRID_CENTER_H + GUI_GRID_CENTER_Y";
        ...
        class SatSelectCombo: LXIR_CC_RscCombo
        {
            idc = 2102;
            x = "15 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X";
            y = "16 * GUI_GRID_CENTER_H + GUI_GRID_CENTER_Y";
        ...
        class CamViewButton: LXIR_CC_RscButton
        {
            idc = 2400;
            text = "View";
        ...
        class DroneViewPltButton: LXIR_CC_RscButton
        {
            idc = 2401;
            text = "PLT";
            x = "27.9 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X";
        ...
        class DroneViewGnrButton: LXIR_CC_RscButton
        {
            idc = 2403;
            text = "GNR";
        ...
        class SatViewButton: LXIR_CC_RscButton
        {
            idc = 2402;
            text = "View";
            x = "27.9 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X";
