class LXIR_ModuleMultiScreen: Module_F
{
    scope = 2;
    displayName = "Setup Multi Screen";
    icon = "\z\lxir\addons\media\images\icons\MultiScreen.paa";
    category = QPREFIX;
    function = "lxir_commandcenter_fnc_moduleMultiScreen";
    functionPriority = 4;
    isGlobal = 0;
    ...
    class Attributes: AttributesBase
    {
        ...
        class MultiScreenDrone: Checkbox
          {
                property = "lxir_MultiScreenDrone";
        ...
        class MultiScreenSelections: Edit
          {
                property = "lxir_MultiScreenSelections";
