...
private _configAction = [
    ...
    "",
    {
        ...
        [_object, _player, _radio] call lxir_commandcenter_fnc_configureRadio;
    },
    { true },
    nil,
    [_object,_radio]
...
private _turnOnAction = [
    ...
    "",
    {
        params ["_target", "_player", "_params"];
        _params params ["_object", "_radio"];
        [_object, _radio, true] call lxir_commandcenter_fnc_turnOnRadio;
    },
    {
        params ["_target", "_player", "_params"];
...
private _turnOffAction = [
    ...
    "",
    {
        params ["_target", "_player", "_params"];
        _params params ["_object", "_radio"];
        [_object, _radio, false] call lxir_commandcenter_fnc_turnOnRadio;
    },
    {
        params ["_target", "_player", "_params"];
        (_params select 1) call TFAR_fnc_getLrSpeakers;
