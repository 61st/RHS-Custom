...
// set up uiNamespace
uiNamespace setVariable ["LXIR_CC_currentRadioObject", _radio];
...
_buttonOK ctrlSetEventHandler ["ButtonClick", format["[] call lxir_commandcenter_fnc_handleRadioConfig"]];
