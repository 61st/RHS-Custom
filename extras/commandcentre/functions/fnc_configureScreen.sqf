...
LXIR_CC_currentScreenObject = _object;
LXIR_CC_currentScreenSelection = _selection;
...
(_display displayCtrl 2400) ctrlSetEventHandler ["ButtonClick", "[] call lxir_commandcenter_fnc_viewHelmetCam"];
(_display displayCtrl 2401) ctrlSetEventHandler ["ButtonClick", "[0] call lxir_commandcenter_fnc_viewDroneCam"];
(_display displayCtrl 2402) ctrlSetEventHandler ["ButtonClick", "[] call lxir_commandcenter_fnc_viewSatImage"];
(_display displayCtrl 2403) ctrlSetEventHandler ["ButtonClick", "[1] call lxir_commandcenter_fnc_viewDroneCam"];
...
// set title
private _screenMode = _object getVariable [format ["LXIR_CC_screen_%1_mode", _selection], ""];
private _screenTarget = _object getVariable [format ["LXIR_CC_screen_%1_target", _selection], ""];
private "_modeName";
...
{
    private _name = "";
    private _section = _x getVariable "LXIR_Section";
...

{
    ...
    _index = _hCamList lbAdd _name;
    _hCamList lbSetData [_index, str _x];
} forEach LXIR_CC_vehicleCamList;
