...
} forEach (cTabHcamlist + LXIR_CC_vehicleCamList);
...
[_object, _selection] call lxir_commandcenter_fnc_deleteCamera;
...
_object setVariable [format ["LXIR_CC_screen_%1_Cam", _selection], [_cam, objNull, _host]];