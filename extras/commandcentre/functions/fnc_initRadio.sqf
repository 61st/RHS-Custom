/*
Function: lxir_commandcenter_fnc_initRadio
...
_object setVariable ["LXIR_CC_radioObject", _radio, true];

// Done setting up, now add the actions for channel switching etc.
[_object, _radio] remoteExec ["lxir_commandcenter_fnc_addRadioActions", 0, true];