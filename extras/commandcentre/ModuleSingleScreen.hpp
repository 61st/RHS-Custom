class LXIR_ModuleSingleScreen: Module_F
{
    scope = 2;
    displayName = "Setup Single Screen";
    icon = "\z\lxir\addons\media\images\icons\SingleScreen.paa";
    category = QPREFIX;
    function = "lxir_commandcenter_fnc_moduleSingleScreen";
    functionPriority = 4;
    isGlobal = 0;
    ...
    class Attributes: AttributesBase
    {
        ...
        class SingleScreenDrone: Checkbox
          {
                property = "lxir_SingleScreenDrone";
        ...
        class SingleScreenSelection: Edit
          {
                property = "lxir_SingleScreenSelection";
