class LXIR_ModuleStationaryRadio: Module_F
{
    scope = 2;
    displayName = "Setup Stationary Radio";
    icon = "\z\lxir\addons\media\images\icons\StationaryRadio.paa"; //todo: proper icon
    category = QPREFIX;
    function = "lxir_commandcenter_fnc_moduleStationaryRadio";
    functionPriority = 4;
    isGlobal = 0;
    ...
    class Attributes: AttributesBase
    {
        class StationaryRadioOn: Checkbox
          {
                property = "lxir_StationaryRadioOn";
        ...
        class StationaryRadioCh1: Edit
          {
                property = "lxir_StationaryRadioCh1";
        ...
        class StationaryRadioCh2: Edit
          {
                property = "lxir_StationaryRadioCh2";
        ...
        class StationaryRadioVol: Edit
          {
                property = "lxir_StationaryRadioVol";
        ...
        class StationaryRadioClass: Edit
          {
                property = "lxir_StationaryRadioClass";
        ...
        class StationaryRadioCode: Edit
          {
                property = "lxir_StationaryRadioCode";
