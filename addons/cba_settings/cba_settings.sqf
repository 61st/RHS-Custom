...
// 61st BFT - bft
force force lxirtca_bft_groupMarkers_colorsBlacklist = "Default, ColorWEST, ColorEAST, ColorGUER, ColorCIV, Color1_FD_F, Color2_FD_F, Color3_FD_F, Color4_FD_F, Color5_FD_F, Color6_FD_F";
force force lxirtca_bft_groupMarkers_defaultSetting = 2;
force force lxirtca_bft_groupMarkers_enabled = true;
force force lxirtca_bft_groupMarkers_fuzzOtherFactions = true;
force force lxirtca_bft_groupMarkers_iconsBlacklist = "unknown, uav";
force force lxirtca_bft_groupMarkers_mapSettings_enabled = true;
force force lxirtca_bft_groupMarkers_markerShape = "a";
force force lxirtca_bft_groupMarkers_nameOptions = "Zulu,Lima,Uniform,Echo,Whiskey,Tango,Bob";
force force lxirtca_bft_groupMarkers_preferredColors = "ColorYellow, ColorRed, ColorBlue, ColorBlack, ColorGreen, ColorWhite, ColorOrange";
force force lxirtca_bft_groupMarkers_preferredIcons = "inf, motor_inf, mech_inf, air, armor, recon";
force force lxirtca_bft_groupMarkers_trackingMode = "weightedAverage";
force force lxirtca_bft_groupMarkers_trailingCount = 5;
force force lxirtca_bft_groupMarkers_trailingMode = "weightedAverage";
force force lxirtca_bft_groupMarkers_trailingWeight = 0.75;
force force lxirtca_bft_groupMarkers_updateDelay = 1;

// 61st BFT - main
force force lxirtca_main_ClearBuildingMarkers_Channel = 0;
force force lxirtca_main_ClearBuildingMarkers_Enabled = false;
force force lxirtca_main_LoadoutDiaryRecord_Enabled = false;

// 61st BFT - unitmarkers
force force lxirtca_unitmarkers_unitMarkers_enabled = true;
force force lxirtca_unitmarkers_unitMarkers_markAI = true;
force force lxirtca_unitmarkers_unitMarkers_otherGroups = true;
force force lxirtca_unitmarkers_unitMarkers_showToggle = true;

// 61st BFT - vehicles
force force lxirtca_vehicles_showSpeedLimiterOptions = true;
force force lxirtca_vehicles_showSpeedLimiterWaitTime = 10;
...
force force lxir_medical_treatment_fatalInjuriesCardiacArrestTimeCoefficient = 0.2;
